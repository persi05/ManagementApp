...
NOTIFICATIONS_PER_PAGE = env_int('NOTIFICATIONS_PER_PAGE', 50)
NOTIFICATIONS_READ_RETENTION_DAYS = env_int('NOTIFICATIONS_READ_RETENTION_DAYS', 30)
NOTIFICATIONS_UNREAD_RETENTION_DAYS = env_int('NOTIFICATIONS_UNREAD_RETENTION_DAYS', 90)
